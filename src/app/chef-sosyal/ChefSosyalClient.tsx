...
import { ChefHat, Search, Bell, Plus, ThumbsUp, Clock, User, Home, BookOpen, Users, Image as ImageIcon, Play, Menu, X, Filter, Type, ArrowDown, Camera, Film, Bookmark } from "lucide-react"
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="w-full max-w-[640px] px-0 sm:px-4 pb-20">
          ...
          <div className="flex items-center space-x-2 mb-4 px-2 sm:px-0 overflow-x-auto scrollbar-hide touch-pan-x">
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-3 py-1.5 rounded-full font-bold text-sm transition-colors whitespace-nowrap ${sortBy === 'popular' ? 'bg-orange-600 text-white shadow-lg shadow-orange-900/20' : 'text-gray-400 hover:bg-gray-800 hover:text-white'}`}
            >
              <span>Popüler</span>
            </button>
            <button
      ...
      {showNewTopicModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-0 sm:p-4">
          ...
          <div className="fixed inset-0 z-[120] sm:relative sm:inset-auto sm:z-auto w-full sm:h-auto sm:max-h-[90vh] sm:max-w-2xl sm:rounded-2xl bg-[#000] sm:border sm:border-gray-800 flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
