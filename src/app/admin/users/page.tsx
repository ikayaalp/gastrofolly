    ...
    <div className="min-h-screen bg-black text-white">
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex space-x-6">
                ...
                <Link href="/admin/users" className="text-white font-semibold">
                  Kullanıcı Yönetimi
                </Link>
      ...
      <div className="pt-20 bg-black border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <p className="text-gray-400 mt-2">Kullanıcıları yönetin ve rollerini değiştirin</p>
        </div>
      </div>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-gray-900/30 backdrop-blur-sm border-t border-gray-800">
        <div className="flex justify-around items-center py-2">
          ...
          <Link href="/admin/users" className="flex flex-col items-center py-2 px-3 text-orange-500">
