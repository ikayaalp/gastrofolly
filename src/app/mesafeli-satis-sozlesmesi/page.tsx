        ...
        <div className="min-h-screen bg-black text-white">
            ...
            <section className="pt-32 pb-16 bg-gradient-to-b from-gray-900 to-black">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-6">Mesafeli Satış Sözleşmesi</h1>
                    ...
                    <div className="prose prose-invert max-w-none space-y-12">
                        <div className="bg-gray-900/30 p-8 rounded-2xl border border-gray-800">
                            <h2 className="text-2xl font-bold mb-4 flex items-center gap-3">
                                <Scale className="text-orange-500" /> 1. Taraflar
                            </h2>
                        ...
                        <div>
                            <h2 className="text-2xl font-bold mb-4 flex items-center gap-3">
                                <FileCheck className="text-orange-500" /> 2. Konu
                            </h2>
                            <p className="text-gray-400">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold mb-4 flex items-center gap-3">
                                <AlertCircle className="text-orange-500" /> 3. Hizmet Bedeli ve Ödeme
                            </h2>
                            <p className="text-gray-400">
                                Hizmetin türü, miktarı, satış bedeli ve ödeme şekli, siparişin sonlandığı andaki bilgilerden oluşmaktadır. ALICI, satın aldığı hizmetin bedelini seçtiği ödeme yöntemi ile ödemeyi kabul eder.
                            </p>
                        </div>

                        <div className="bg-orange-600/10 border border-orange-500/20 p-6 rounded-xl">
                            <h2 className="text-xl font-bold mb-3 flex items-center gap-2">
                                <Info className="text-orange-500" /> Cayma Hakkı Bilgilendirmesi
                            </h2>
                            <p className="text-sm text-gray-300">
                                Dijital içerik hizmetleri, ALICI'nın onayı ile anında ifa edilen hizmetler kapsamında olduğundan, içeriğe erişim sağlandığı andan itibaren cayma hakkı kullanılamaz.
                            </p>
                        </div>
                    </div>
                </div>
