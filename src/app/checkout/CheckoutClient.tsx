...
function CheckoutContent({ monthlyPrice, yearlyPrice }: CheckoutClientProps) {
  ...
  const originalPrice = billingPeriod === "monthly" ? basePrice : basePrice * 12
  // Dönem indirimi
  const periodDiscountedPrice = billingPeriod === "monthly" ? basePrice : (selectedPlan?.price || 0)
