            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <button
                  ...
                  className="group w-full flex items-center justify-center gap-3 py-3 px-4 bg-white hover:bg-gray-50 border-0 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]"
                >
                  ...
                  <span className="text-gray-700 font-semibold text-sm">Google ile devam et</span>
                </button>
              </div>
            </div>
          </form>
