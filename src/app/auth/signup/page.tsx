        ...
        <div className="backdrop-blur-md bg-black/60 border border-white/10 rounded-xl shadow-2xl p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-black/60 text-gray-400">veya</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-white hover:bg-gray-100 border border-gray-300 rounded-md shadow-sm transition-colors"
          >
            ...
            <span className="text-gray-700 font-semibold text-sm">Google ile Hesap Oluştur</span>
          </button>
        </div>
      </div>
    </div>
