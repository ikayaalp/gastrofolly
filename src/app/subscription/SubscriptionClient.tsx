...
import { ChefHat, Check, Sparkles, BookOpen, Award, Users, MessageCircle, Home, Zap, Star, Loader2 } from "lucide-react"
...
function SubscriptionContent({ monthlyPrice, yearlyPrice }: SubscriptionClientProps) {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="flex justify-center mb-16">
                        {(() => {
                            ...
                            const yearlyBasePrice = yearlyPrice
...
export default function SubscriptionClient(props: SubscriptionClientProps) {
    return (
        <Suspense fallback={
