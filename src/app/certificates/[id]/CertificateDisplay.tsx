...
export default function CertificateDisplay({ certificate }: CertificateDisplayProps) {
    return (
        <div className="min-h-screen bg-black text-white">
            {/* Header */}
            <div className="bg-gray-900/30 backdrop-blur-sm border-b border-gray-800 px-4 py-4 no-print">
            ...
            <main className="max-w-4xl mx-auto px-4 py-12">
                <div
                    className="bg-gradient-to-br from-gray-900 via-black to-gray-900 rounded-xl border-4 border-orange-500/30 p-12 shadow-2xl"
                    style={{
                        backgroundImage:
                            'radial-gradient(circle at 20% 50%, rgba(251, 146, 60, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(239, 68, 68, 0.1) 0%, transparent 50%)',
                    }}
                >
                    {/* Certificate Header */}
                    ...
                    <div className="text-center space-y-6 mb-8">
                        <p className="text-gray-300 text-lg">Bu sertifika ile onaylanır ki,</p>
                        ...
                        <p className="text-gray-300 text-lg">aşağıdaki kursu başarıyla tamamlamıştır:</p>
                        ...
                        <div className="py-6 px-8 bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-lg border border-orange-500/30">
                            ...
                            {certificate.course.instructor?.name && (
                                <p className="text-gray-400">Eğitmen: {certificate.course.instructor.name}</p>
                            )}
                        </div>
                    ...
                    <div className="flex items-center justify-between pt-8 border-t border-gray-800">
                        ...
                        <div className="text-center flex-1">
                            ...
                            <p className="text-sm text-gray-500">
                                Sertifika No: {certificate.id.slice(0, 8).toUpperCase()}
                            </p>
                        </div>
                    </div>
                </div>
