      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setIsOpen(false)}>
            <div
              className="w-full max-w-sm bg-[#111] border border-gray-800 rounded-2xl shadow-2xl overflow-hidden"
              onClick={(e) => e.stopPropagation()}
              style={{ animation: 'modalIn 0.2s ease-out' }}
            >
              {/* Header */}
              <div className="flex items-center justify-between px-5 pt-5 pb-3">
                <h3 className="text-white font-bold text-lg">Paylaş</h3>
                <button
                  onClick={() => setIsOpen(false)}
              ...
              <div className="px-5 py-4">
                <div className="flex items-center justify-center gap-4">
                  ...
                  >
                    ...
                    <span className="text-[11px] text-gray-400">LinkedIn</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="text-[11px] text-gray-400">E-posta</span>
                  </button>
                </div>
              </div>

              {/* Divider */}
              <div className="mx-5 border-t border-gray-800"></div>

              {/* Copy Link */}
              <div className="px-5 py-4">
                <p className="text-xs text-gray-500 mb-2">veya linki kopyala</p>
                <div className="flex items-center gap-2">
                  <div className="flex-1 bg-black border border-gray-800 rounded-lg px-3 py-2.5 text-sm text-gray-400 truncate">
                    {courseUrl}
                  </div>
                  <button
