            ...
            <div className="p-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="flex items-center justify-center p-3 bg-[#25D366] hover:bg-[#1da851] text-white rounded-lg transition-colors"
                >
                  <WhatsAppIcon />
                ...
                <button
                  ...
                  className="flex items-center justify-center p-3 bg-[#1877F2] hover:bg-[#1565c0] text-white rounded-lg transition-colors"
                >
                  <FacebookIcon />
                ...
                <button
                  ...
                  className="flex items-center justify-center p-3 bg-black hover:bg-gray-900 text-white rounded-lg transition-colors border border-gray-700"
                >
                  <XIcon />
                ...
                <button
                  ...
                  className="flex items-center justify-center p-3 bg-[#0A66C2] hover:bg-[#094d92] text-white rounded-lg transition-colors"
                >
                  <LinkedInIcon />
                ...
                <button
                  ...
                  className="flex items-center justify-center p-3 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors col-span-2"
                >
