        ...
        {courses.map((course) => {
          ...
          return (
            <Link key={course.id} href={linkHref}>
              <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden hover:border-orange-500/50 transition-all duration-300 group cursor-pointer min-w-[320px] w-[320px] flex-shrink-0">
                {/* Course Image */}
